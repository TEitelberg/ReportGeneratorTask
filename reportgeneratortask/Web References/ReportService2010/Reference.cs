...
namespace SSISComponents.ReportGenerator.ReportService2010 {
    using System;
    ...
    public partial class ReportingService2010 : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public ReportingService2010() {
            this.Url = global::SSISComponents.ReportGenerator.Properties.Settings.Default.SSISComponents_DTS_Tasks_ReportGeneratorTask_SharePoint_ReportingService2010;
        ...
        public string GetRoleProperties(string Name, string SiteUrl, out string[] TaskIDs) {
            object[] results = this.Invoke("GetRoleProperties", new object[] {
                        Name,
                        SiteUrl});
            TaskIDs = ((string[])(results[1]));
            return ((string)(results[0]));
        }
